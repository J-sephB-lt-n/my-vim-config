...
:command InitPythonLogger normal! 0i# set up python logger #<cr>logging.basicConfig(level=logging.INFO, format="%(asctime)s - %(name)s - %(levelname)s - %(message)s")<cr>logger = logging.getLogger(__name__)<Esc><cr>
